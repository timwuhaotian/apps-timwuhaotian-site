...
export const apps = [
  ...
  },
  {
    slug: "sec-daily",
    name: "FilingsDaily",
    tagline: "SEC filings, decoded in sixty seconds.",
    summary:
      "FilingsDaily scans SEC EDGAR every trading day, scores filings with AI, and curates a concise daily briefing of the most newsworthy reports — with plain-English summaries and Chinese translation. An archive and search are available for premium readers.",
    platforms: ["iOS"],
    status: "in development",
    bundleId: "dev.timwuhaotian.filingsdaily",
    supportEmail,
    legalOwner,
    ...
    features: [
      ...
      "Plain-English summaries of each filing, with Simplified Chinese translation.",
      "Archive and search for premium readers.",
      "Free tier with a limited daily signal count; premium unlocks the full briefing.",
    ],
    policyProfile: {
      dataUse: [
        "daily SEC filings briefings and curated signals",
        "reading status and archive access state",
        "search queries",
        "subscription status",
      ],
      storage:
        "FilingsDaily stores reading preferences, archive access state, and subscription state on your device and on supporting backend services. Filing data is sourced from SEC EDGAR and processed on the backend; AI scoring and summaries are generated server-side.",
      sharing:
        "Reader data is not sold. Payment processing and subscription status may be handled by platform services. Filing source material remains owned by the SEC and original filers.",
      permissions: [
        "Network access fetches daily filings, archive data, and summaries.",
        "In-app purchase access manages premium briefing access.",
      ],
      paidFeatures:
        "Paid features may unlock the full daily briefing, complete archives, search access, and all summaries. Subscriptions are charged to your Apple ID and renew automatically unless cancelled at least 24 hours before the end of the current period.",
      termsUse:
        "Use FilingsDaily for informational awareness and research only. FilingsDaily does not provide buy or sell recommendations, price targets, or promises of return, and nothing in the briefing constitutes investment advice. Verify details against original SEC filings before acting.",
      availability:
        "Briefing availability depends on SEC EDGAR feeds, backend processing, network access, the trading calendar, and subscription state.",
    },
  },
  {
    slug: "cve-daily",
    name: "CVE Daily",
    tagline: "Today's CVEs, explained in plain language.",
    summary:
      "CVE Daily pulls each day's security vulnerabilities from NVD and CISA KEV, curates the most relevant ones by industry, and explains them in plain English with Simplified Chinese translation — generated by AI on the backend. An archive and search are available for premium readers.",
    platforms: ["iOS"],
    status: "in development",
    bundleId: "com.gosingk.cvedaily",
    supportEmail,
    legalOwner,
    privacyUpdatedAt: "2026-07-19",
    termsUpdatedAt: "2026-07-19",
    ...
    features: [
      ...
      "Per-industry curation so you see the vulnerabilities that matter to your stack.",
      "Plain-language AI explanations in English and Simplified Chinese.",
      "Archive and search for premium readers.",
      "Free tier with a limited daily digest count; premium unlocks the full list.",
    ],
    policyProfile: {
      dataUse: [
        "daily CVE briefings and curated vulnerability signals",
        "reading status and archive access state",
        "search queries",
        "subscription status",
      ],
      storage:
        "CVE Daily stores reading preferences, archive access state, and subscription state on your device and on supporting backend services. Vulnerability data is sourced from NVD and CISA; plain-language insights are generated server-side by AI.",
      sharing:
        "Reader data is not sold. Payment processing and subscription status may be handled by platform services. Vulnerability source material remains owned by NVD, MITRE, and CISA.",
      permissions: [
        "Network access fetches daily vulnerabilities, archive data, and insights.",
        "In-app purchase access manages premium digest access.",
      ],
      paidFeatures:
        "Paid features may unlock the full daily digest, complete archives, search access, and all insights. Subscriptions are charged to your Apple ID and renew automatically unless cancelled at least 24 hours before the end of the current period.",
      termsUse:
        "Use CVE Daily for informational awareness and prioritization only. CVE Daily does not guarantee completeness or timeliness of vulnerability data and does not constitute professional security advice. Verify details against original advisories before acting.",
      availability:
        "Briefing availability depends on NVD and CISA feeds, backend processing, network access, and subscription state.",
    },
  },
